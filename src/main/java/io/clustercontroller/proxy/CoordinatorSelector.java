...
public class CoordinatorSelector {
    ...
    public SearchUnit selectCoordinator(String clusterId) throws Exception {
        ...
        // Get all coordinators from MetadataStore
        ...
        log.info("Selected coordinator '{}' for cluster '{}'", selected.getName(), clusterId);
